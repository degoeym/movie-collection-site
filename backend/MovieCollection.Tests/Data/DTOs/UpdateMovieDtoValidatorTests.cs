...
public class UpdateMovieDtoValidatorTests
{
    private readonly UpdateMovieDtoValidator _validator = new();

    private static UpdateMovieDto CreateValidDto() => new()
    {
        Title = "Blade Runner",
        Description = "Do androids dream?",
        Rating = Rating.R,
        ReleaseDate = DateTime.UtcNow.AddYears(-40)
    };
    ...
    public async Task Validate_ShouldFail_WhenTitleEmpty()
    {
        ...
        result.Errors.ShouldContain(e => e.PropertyName == nameof(UpdateMovieDto.Title));
    }
    ...
    public async Task Validate_ShouldFail_WhenDescriptionEmpty()
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors.ShouldContain(e => e.PropertyName == nameof(UpdateMovieDto.Description));
    }
    ...
    public async Task Validate_ShouldFail_WhenRatingIsDefault()
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors.ShouldContain(e => e.PropertyName == nameof(UpdateMovieDto.Rating));
    }
    ...
    public async Task Validate_ShouldFail_WhenReleaseDateInFuture()
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors.ShouldContain(e => e.PropertyName == nameof(UpdateMovieDto.ReleaseDate));
    }
